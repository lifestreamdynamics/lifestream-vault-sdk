 ...
 * ```
 */
export declare class ScimResource {
    private http;
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    createUser(data: ScimCreateUserInput): Promise<ScimUser>;
    /**
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    updateUser(id: string, data: ScimUpdateUserInput): Promise<ScimUser>;
    /**
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    getServiceProviderConfig(): Promise<ScimServiceProviderConfig>;
}
