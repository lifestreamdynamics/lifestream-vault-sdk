...
export class VaultsResource {
    ...
    async get(vaultId) {
        try {
            const data = await this.http.get(`vaults/${vaultId}`).json();
            return data.vault;
        }
        catch (error) {
    ...
    async create(params) {
        try {
            const data = await this.http.post('vaults', { json: params }).json();
            return data.vault;
        }
        catch (error) {
    ...
    async update(vaultId, params) {
        try {
            const data = await this.http.patch(`vaults/${vaultId}`, { json: params }).json();
            return data.vault;
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async getTree(vaultId) {
        try {
            const data = await this.http.get(`vaults/${vaultId}/tree`).json();
            return data.tree;
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async archive(vaultId) {
        try {
            const data = await this.http.patch(`vaults/${vaultId}/archive`).json();
            return data.vault;
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async unarchive(vaultId) {
        try {
            const data = await this.http.patch(`vaults/${vaultId}/unarchive`).json();
            return data.vault;
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async createExport(vaultId, params) {
        try {
            return await this.http.post(`vaults/${vaultId}/export`, { json: params ?? {} }).json();
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
        }
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async listExports(vaultId) {
        try {
            const data = await this.http.get(`vaults/${vaultId}/export`).json();
            return data.exports;
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async downloadExport(vaultId, exportId) {
        try {
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async transfer(vaultId, targetEmail) {
        try {
            const data = await this.http.post(`vaults/${vaultId}/transfer`, { json: { targetEmail } }).json();
            return data.vault;
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async getMfaConfig(vaultId) {
        try {
            return await this.http.get(`vaults/${vaultId}/mfa`).json();
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
        }
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async setMfaConfig(vaultId, params) {
        try {
            return await this.http.put(`vaults/${vaultId}/mfa`, { json: params }).json();
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
        }
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    async verifyMfa(vaultId, params) {
        try {
            return await this.http.post(`vaults/${vaultId}/mfa/verify`, { json: params }).json();
        }
        catch (error) {
            throw await handleError(error, 'Vault', vaultId);
        }
