 ...
 * ```
 */
export declare class PublishVaultResource {
    private http;
     ...
     */
    listMine(): Promise<PublishedVault[]>;
    /**
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    publish(vaultId: string, params: PublishVaultParams): Promise<PublishedVault>;
    /**
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    update(vaultId: string, params: Partial<PublishVaultParams>): Promise<PublishedVault>;
    /**
     ...
     * @throws {NetworkError} If the request fails due to network issues
     */
    unpublish(vaultId: string): Promise<void>;
}
//# sourceMappingURL=publish-vault.d.ts.map